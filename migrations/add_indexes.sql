-- Enable earthdistance extension for spatial queries (optional)
...
-- Spatial index for locations (using simple lat/lng index instead of earthdistance)
-- If you need advanced spatial queries, uncomment the earthdistance extension above
-- and use: CREATE INDEX IF NOT EXISTS idx_locations_coordinates ON locations USING gist (ll_to_earth(latitude, longitude));
